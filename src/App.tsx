      ...
      <main>
        ...
        <nav className={styles.g_navi}>
          <ul className={styles.g_navi_ul}>
            <li className={styles.g_navi_ul_li}><a href={"#test1"}>あらまし</a></li>
            <li className={styles.g_navi_ul_li}><a href={"#test2"}>どんな人材を育てたい？</a></li>
            <li className={styles.g_navi_ul_li}><a href={"#test3"}>どんなプログラムが必要？</a></li>
            <li className={styles.g_navi_ul_li}><a href={"#test4"}>その人材の未来</a></li>
          </ul>
        </nav>
        <div id={"test1"}>
          ...
          <div className={styles.box1}>
            ...
            <ModalContent image={"https://d1obh0a64dzipo.cloudfront.net/images/5856.jpg"}
              ...
              <a href={"https://minorasu.basf.co.jp/80466"}>
                <p>出典：農林水産省「農林業センサス」よりminorasu編集部作成</p>
              </a>
            </ModalContent>
          </div>
          <div className={styles.box1}>
          ...
          <div className={styles.box1}>
            <p className={styles.text}>
              ...
              負のイメージが強く若者が積極的になりたいと思わない。<br/>
              見方が変わるきっかけに！
            </p>
            <ModalContent
              image={"https://www.ryutsu-kenkyusho.co.jp/cms/wp-content/uploads/2015/10/93F182CCE7DD82AA8Ea82E991E61848D86_907D87C.png"}
              modalIsOpen={modalIsOpen2}
              setIsOpen={setIsOpen2}>
              <a href={"https://www.ryutsu-kenkyusho.co.jp/columns/新規就農の課題と展望-～頑張れ！新規就農者～/"}>
                <p>出典：全国農業会議所「新規就農者の就農実態に関する調査結果」ｎ=711</p>
              </a>
            </ModalContent>
          </div>
        </div>
        ...
        <div id={"test2"}>
          ...
          <div className={styles.box2}>
            <p
              className={styles.text}>農家の現状を知り、技術やマンパワーで貢献したいと思うような農業に関心を持った人材を育てる。</p>
          </div>
        </div>
        ...
        <div id={"test3"}>
          ...
          <div className={styles.box3}>
            ...
            <ModalContent image={"https://www.maff.go.jp/j/nousin/sekkei/midori/m_manabi/taiken/img/einou1.jpg"}
              ...
              <a href={"https://www.maff.go.jp/j/nousin/sekkei/midori/m_manabi/taiken/index.html"}>
                <p>出典：農林水産省</p>
              </a>
            </ModalContent>
          </div>
